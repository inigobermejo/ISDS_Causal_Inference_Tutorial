...
Use the model to predict mean outcome for observations with treatment set to 0 (interv=0) and to 1 (interv=1)

```{r}
onesample$predicted_meanY <- ### MISSING CODE HERE
```
...
standardisation <- function(data, indices) {
  ...
  d.onesample$predicted_meanY <- ### MISSING CODE HERE
